...
namespace iroha {
  ...
  ExecutionResult CommandExecutor::operator()(
    ...
    commands->addAssetQuantity(command->accountId(),
                               command->assetId(),
                               std::string(command->amount().toStringRepr()),
...
//              command->assetId()).str(), command_name);
//        }
...
//              command->accountId()).str(), command_name);
//        }
//        auto account_asset =
//            queries->getAccountAsset(command->accountId(),
//            command->assetId());
//
//        auto new_balance =
//        amount_builder_.precision(command->amount().precision())
...
//              } else {
//                result =
//                account_asset_builder_.balance(*new_balance_val.value)
//                             .accountId(command->accountId())
//                             .assetId(command->assetId())
//                             .build();
//              }
...
//            [&command_name](const auto &error) -> AccountAssetResult {
//              return makeExecutionError(
//                  "amount builder failed. reason " + *error.error,
//                  command_name);
//            });
//
...
//                  command_name);
//            },
//            [&command_name](const auto &account_asset_error) ->
//            ExecutionResult {
